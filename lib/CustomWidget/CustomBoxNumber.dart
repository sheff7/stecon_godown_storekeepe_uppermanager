...
class CustomBox1Number extends StatelessWidget {
  final TextEditingController controller;
  final String label;

  final bool Enabled;
  const CustomBox1Number({Key? key, required this.controller, required this.label, required this.Enabled}) : super(key: key);
