...
import '../Controller/AddMaterialReplacedDetailsController.dart';

class AddMaterialRepalcedDetails extends StatelessWidget {
  AddMaterialRepalcedDetails({Key? key}) : super(key: key);

  late final materialReplacedOrder =
      Get.put(AddMaterialReplacedDetailsControllerSk());
