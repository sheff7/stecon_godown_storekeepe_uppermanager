...
class AddDamageMaterialDetails extends StatefulWidget {
  const AddDamageMaterialDetails({Key? key}) : super(key: key);

  @override
  State<AddDamageMaterialDetails> createState() => _AddDamageMaterialDetailsState();
}

class _AddDamageMaterialDetailsState extends State<AddDamageMaterialDetails> {
  ...
  String? ChooseReplaceNo;
  List ReplaceList = ['52565', '5588855', '444558'];
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        NormalText(text: 'Damaged no : 57685 85996'),
                      ],
                    ),
                    SizedBox(
                      height: 3.h,
                    ...
                    Container(
                      ...
                      child: DropdownButton(
                        ...
                        hint: Padding(
                          padding: const EdgeInsets.only(left: 10),
                          child: Text('Replaced No..'),
                        ),
                        onChanged: (value) {},
                        items: ReplaceList.map((valueItem) {
                          return DropdownMenuItem(
                              value: valueItem,
                              child: Padding(
                                padding: const EdgeInsets.only(left: 10),
