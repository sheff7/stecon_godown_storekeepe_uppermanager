...
import '../Controller/EditDamagedMaterialSkController.dart';


class EditDamagedMaterialDetails extends StatelessWidget {
  final String id;
  EditDamagedMaterialDetails({Key? key, required this.id}) : super(key: key);

  late final materialReplacedOrder =
  Get.put(EditDamagedMaterialControllerSk(id));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 0,
          title: Header(
            text: 'Edit Damaged material deatils',
          ),
          centerTitle: true,
          leading: IconButton(
            icon: Icon(
