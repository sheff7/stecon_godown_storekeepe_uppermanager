...
class AddIssuedMaterialDeatils extends StatefulWidget {
  const AddIssuedMaterialDeatils({Key? key}) : super(key: key);

  @override
  State<AddIssuedMaterialDeatils> createState() => _AddIssuedMaterialDeatilsState();
}

class _AddIssuedMaterialDeatilsState extends State<AddIssuedMaterialDeatils> {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomField(controller: commentController, label: 'Comment'),
                  SizedBox(height: 4.h,),
