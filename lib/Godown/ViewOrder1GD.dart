...
class ViewOrder1GD extends StatelessWidget {
  const ViewOrder1GD({Key? key}) : super(key: key);
          ...
          Row(
            children: [
              Expanded(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      NormalText(text: 'Rep Name : '),
                      SizedBox(
                        height: 2.h,
                      ),
                      NormalText(text: 'ID Number : '),
                      SizedBox(
                        height: 2.h,
                      ),
              ...
              Expanded(
                flex: 2,
                child: Container(
                  padding: EdgeInsets.symmetric(horizontal: 0.h, vertical: 3.h),
                  color: Colors.white,
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      BoldText(text: 'Yadu Krishnan'),
                      SizedBox(
                        height: 2.h,
                      ),
                      BoldText(text: '65757 4758'),
                      SizedBox(
                        height: 2.h,
                      ),
                      BoldText(text: 'Pranav N K'),
                      SizedBox(
                        height: 2.h,
                      ),
                      BoldText(text: '78909 786467'),
                      SizedBox(
                        height: 2.h,
                      ),
                      BoldText(text: 'yadukrishnan@gmail.com'),
                      SizedBox(
                        height: 2.h,
                      ),
                      BoldText(text: '505'),
