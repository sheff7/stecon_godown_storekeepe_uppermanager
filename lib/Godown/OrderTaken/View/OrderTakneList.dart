...
import '../../DeliverySchedulefn/View/DeliveryScheduleSingleViewGd.dart';
import '../Controller/OrderTakenListController.dart';
import 'OrderTakenSingle.dart';
class OrderTakenList extends StatelessWidget {
   OrderTakenList({Key? key}) : super(key: key);

  late final _deliveryScheduleListGdController =
  Get.put(OrderTakenListController());
