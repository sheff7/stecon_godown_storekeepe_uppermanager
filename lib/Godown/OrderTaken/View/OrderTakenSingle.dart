...
import '../Controller/OrderTakenSingleController.dart';

class OrderTakenSingle extends StatelessWidget {
  final String id;
   OrderTakenSingle({Key? key, required this.id}) : super(key: key);
  late final _controller =
  Get.put(OrderTakenSingleController(id: id));
  @override
                                          ...
                                          title: Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                SubHeadingText(text: 'Packed Date :  ${_controller
                                                    .deliveryScheduleSingleViewGdEntity
                                                    .value
                                                    .deliveryschedule![index]
                                                    .packeddate
