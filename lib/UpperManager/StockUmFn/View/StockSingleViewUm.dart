...
import '../Controller/StockSingleViewUmController.dart';



class StockSingleViewUm extends StatelessWidget {
  final String productid;
  StockSingleViewUm({Key? key,required this.productid}) : super(key: key);
  late final productListController = Get.put(StockListSingleViewUmController(Productid: productid,));
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                            ...
                            child:_image(productListController.productListEntity.value.stocklist![0].coverimageurl.toString())
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              productListController.productListEntity.value.stocklist![0].artno.toString(),
                            ...
                            SizedBox(height: 2.h,),
                            BoldText(text:  productListController.productListEntity.value.stocklist![0].comments.toString()),
                                  ...
                                  child: Container(
                                    child: Padding(
                                      ...
                                      child: Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          NormalText(text:  productListController.productListEntity.value.stocklist![0].categoryname.toString()),
                                          SizedBox(
                                            height: 2.h,
                                          ),
                                          NormalText(text:  productListController.productListEntity.value.stocklist![0].colorname.toString()),
                                          SizedBox(
                                            height: 2.h,
                                          ),
                                          NormalText(
