...
import '../Repository/StockSingleViewUmServices.dart';




class StockListSingleViewUmController extends GetxController {
  final String Productid;
  RxBool networkStatus = true.obs;
  RxBool loadingBool = false.obs;
  Rx<StockSingleViewUmEntity> productListEntity = StockSingleViewUmEntity().obs;
  ...
  StockListSingleViewUmController({required this.Productid});
  ...
  getProductList() async {
    ...
    if (nBool == true) {
      ...
      productListEntity.value = (await StockSingleViewUmServices()
          .getPrdouctList(Productid))!;

      if(productListEntity.value!=null){
        if(productListEntity.value.response=='Success'){
          sizeListGrid.clear();
          if(productListEntity.value.stocklist!.length!=0){
            size1controller.text=productListEntity.value.stocklist![0].s1.toString();
            size2controller.text=productListEntity.value.stocklist![0].s2.toString();
            size3controller.text=productListEntity.value.stocklist![0].s3.toString();
            size4controller.text=productListEntity.value.stocklist![0].s4.toString();
            size5controller.text=productListEntity.value.stocklist![0].s5.toString();
            size6controller.text=productListEntity.value.stocklist![0].s6.toString();
            size7controller.text=productListEntity.value.stocklist![0].s7.toString();
            size8controller.text=productListEntity.value.stocklist![0].s8.toString();
            size9controller.text=productListEntity.value.stocklist![0].s9.toString();
            size10controller.text=productListEntity.value.stocklist![0].s10.toString();
            size11controller.text=productListEntity.value.stocklist![0].s11.toString();
            size12controller.text=productListEntity.value.stocklist![0].s12.toString();
            size13controller.text=productListEntity.value.stocklist![0].s13.toString();


            if(productListEntity.value.stocklist![0].s1.toString().length!=0){
              sizeListGrid.add(size1());
            }
            if(productListEntity.value.stocklist![0].s2.toString().length!=0){
              sizeListGrid.add(size2());
            }
            if(productListEntity.value.stocklist![0].s3.toString().length!=0){
              sizeListGrid.add(size3());
            }
            if(productListEntity.value.stocklist![0].s4.toString().length!=0){
              sizeListGrid.add(size4());
            }
            if(productListEntity.value.stocklist![0].s5.toString().length!=0){
              sizeListGrid.add(size5());
            }
            if(productListEntity.value.stocklist![0].s6.toString().length!=0){
              sizeListGrid.add(size6());
            }
            if(productListEntity.value.stocklist![0].s7.toString().length!=0){
              sizeListGrid.add(size7());
            }
            if(productListEntity.value.stocklist![0].s8.toString().length!=0){
              sizeListGrid.add(size8());
            }
            if(productListEntity.value.stocklist![0].s9.toString().length!=0){
              sizeListGrid.add(size9());
            }
            if(productListEntity.value.stocklist![0].s10.toString().length!=0){
              sizeListGrid.add(size10());
            }
            if(productListEntity.value.stocklist![0].s11.toString().length!=0){
              sizeListGrid.add(size11());
            }
            if(productListEntity.value.stocklist![0].s12.toString().length!=0){
              sizeListGrid.add(size12());
            }
            if(productListEntity.value.stocklist![0].s13.toString().length!=0){
