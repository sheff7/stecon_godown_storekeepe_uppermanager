...
class AddUpperCountStatus2UPMController  extends GetxController{
    ...
    if (nBool == true){
      ...
      if(orderNoEntity.value!=null){
        if(orderNoEntity.value.response=='Success'){
          ...
          CommentsController.text=orderNoEntity.value.purchaseproductlist![0].note.toString();
          print("oomb"+orderNoEntity.value.purchaseproductlist![0].note.toString());
          ...
          if(orderNoEntity.value.purchaseproductlist![0].s1.toString()!='0'){
            enable1.value=true;
            sizeListGrid.add(size1());
          }
          if(orderNoEntity.value.purchaseproductlist![0].s2.toString()!='0'){
            enable2.value=true;
            sizeListGrid.add(size2());

          }
          if(orderNoEntity.value.purchaseproductlist![0].s3.toString()!='0'){
            enable3.value=true;
            sizeListGrid.add(size3());

          }
          if(orderNoEntity.value.purchaseproductlist![0].s4.toString()!='0'){
            enable4.value=true;
            sizeListGrid.add(size4());

          }
          if(orderNoEntity.value.purchaseproductlist![0].s5.toString()!='0'){
            enable5.value=true;
            sizeListGrid.add(size5());

          }
          if(orderNoEntity.value.purchaseproductlist![0].s6.toString()!='0'){
            enable6.value=true;
            sizeListGrid.add(size6());

          }
          if(orderNoEntity.value.purchaseproductlist![0].s7.toString()!='0'){
            enable7.value=true;
            sizeListGrid.add(size7());

          }
          if(orderNoEntity.value.purchaseproductlist![0].s8.toString()!='0'){
            enable8.value=true;
            sizeListGrid.add(size8());

          }
          if(orderNoEntity.value.purchaseproductlist![0].s9.toString()!='0'){
            enable9.value=true;
            sizeListGrid.add(size9());

          }
          if(orderNoEntity.value.purchaseproductlist![0].s10.toString()!='0'){
            enable1.value=true;
            sizeListGrid.add(size10());

          }
          if(orderNoEntity.value.purchaseproductlist![0].s11.toString()!='0'){
            enable11.value=true;
            sizeListGrid.add(size11());

          }
          if(orderNoEntity.value.purchaseproductlist![0].s12.toString()!='0'){
            enable12.value=true;
            sizeListGrid.add(size12());

          }
          if(orderNoEntity.value.purchaseproductlist![0].s13.toString()!='0'){
            enable13.value=true;
          ...
          if(orderNoEntity.value.recivedsupliercount!.length!=0){
            rcCountId.value=orderNoEntity.value.recivedsupliercount![0].id.toString();
            size1controller.text=orderNoEntity.value.recivedsupliercount![0].s1.toString();
            size2controller.text=orderNoEntity.value.recivedsupliercount![0].s2.toString();
            size3controller.text=orderNoEntity.value.recivedsupliercount![0].s3.toString();
            size4controller.text=orderNoEntity.value.recivedsupliercount![0].s4.toString();
            size5controller.text=orderNoEntity.value.recivedsupliercount![0].s5.toString();
            size6controller.text=orderNoEntity.value.recivedsupliercount![0].s6.toString();
            size7controller.text=orderNoEntity.value.recivedsupliercount![0].s7.toString();
            size8controller.text=orderNoEntity.value.recivedsupliercount![0].s8.toString();
            size9controller.text=orderNoEntity.value.recivedsupliercount![0].s9.toString();
            size10controller.text=orderNoEntity.value.recivedsupliercount![0].s10.toString();
            size11controller.text=orderNoEntity.value.recivedsupliercount![0].s11.toString();
            size12controller.text=orderNoEntity.value.recivedsupliercount![0].s12.toString();
            size13controller.text=orderNoEntity.value.recivedsupliercount![0].s13.toString();
  ...
  addUpperCount(List<Map<String,dynamic>> rcList,List<Map<String,dynamic>> dcList,List<Map<String,dynamic>> rcCountList,String comment)async{
    ...
    if (nBool == true){
     ...
     CustomSnackbar().LoadingBottomSheet();
     responseEntity.value=(await UpperCountStatus0UPMServie().addUpperCount(orderno, comapnyPlanno.value, upperOrderId.value, companyid.value, dateofcounting.value, comment, planNo.value, rcList, dcList, staffList,rcCountList))!;
     Get.back();
  ...
  editUpperCount(List<Map<String,dynamic>> rcList,List<Map<String,dynamic>> dcList,List<Map<String,dynamic>> rcCountList,String comment)async{
    List<Map<String,dynamic>>staffList=[];
    bool nBool = (await NetworkConnectivity().checkConnectivityState())!;
    if (nBool == true){
      for(int i=0;i<staffEnebtity.value.stafflist!.length;i++){
      ...
      CustomSnackbar().LoadingBottomSheet();
      responseEntity.value=(await UpperCountStatus0UPMServie().editUpperCount(orderno, comapnyPlanno.value, upperOrderId.value, companyid.value, dateofcounting.value, comment, planNo.value, rcList, dcList, staffList,rcCountList,countId.value.toString(),rcId.value.toString(),dcId.value.toString(),rcCountId.value.toString()))!;
      Get.back();
