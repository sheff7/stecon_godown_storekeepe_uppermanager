...
import 'package:stecon_godown_storekeepe_uppermanager/UpperManager/UpperReturnCount/Controller/EditUppperReturnController.dart';

import '../../../CustomFont/Header.dart';
import '../../../CustomFont/SubHeading.dart';

class EditUpperReturn extends StatelessWidget {
  final String id;
  final String orderId;
  final String orderNo;
  final String supplierId;
   EditUpperReturn({Key? key, required this.id, required this.orderId, required this.orderNo, required this.supplierId}) : super(key: key);
  late final _controller=Get.put(EditUpperReturnController(id: id, orderId: orderId, orderNo: orderNo, supplierId: supplierId));
